...
namespace Com.ZY.JXKK.DAO.Set
{
    ...
    public class TBTypeDAO
    {
        ...
        /// </summary>
        public void Delete(DataAccess data,string typeCode,string tableName)
        {
        ...
        public List<TBType> GetList(string strSQL,Param param)
        {
        ...
        /// </summary>
        /// <returns>类型设置列表对象</returns>
        public List<TBType> GetList(string field, string value)
        {
            List<TBType> list = new List<TBType>();
            try
            {
