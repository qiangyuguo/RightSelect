...
namespace Com.ZY.JXKK.DAO.Set
{
    ...
    public class TSMaxDAO
    {
        ...
        /// </summary>
        public void Add(DataAccess data,TSMax tsMax)
        {
        ...
        /// <param name="tsMax">最大值表</param>
        /// </summary>
        public void Edit(DataAccess data,TSMax tsMax)
        {
        ...
        /// </summary>
        public void Delete(DataAccess data,string tabName)
        {
        ...
        public List<TSMax> GetList(string strSQL,Param param)
        {
        ...
        /// </summary>
        /// <returns>最大值表列表对象</returns>
        public List<TSMax> GetList(string field, string value)
        {
            List<TSMax> list = new List<TSMax>();
            try
            {
        ...
        /// </summary>
        /// <returns>最大值表对象</returns>
        private TSMax ReadData(ComDataReader dr)
        {
