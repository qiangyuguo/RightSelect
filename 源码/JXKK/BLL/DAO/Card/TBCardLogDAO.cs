...
namespace Com.ZY.JXKK.DAO.Card
{
    ...
    public class TBCardLogDAO
    {
        ...
        /// <param name="tbCardLog">卡片日志</param>
        /// </summary>
        public void Add(TBCardLog tbCardLog)
        {
            try
            {
                db.Open();
        ...
        public List<TBCardLog> GetList(string strSQL,Param param)
        {
        ...
        /// </summary>
        /// <returns>卡片日志列表对象</returns>
        public List<TBCardLog> GetList(string field, string value)
        {
            List<TBCardLog> list = new List<TBCardLog>();
            try
            {
