...
namespace Com.ZY.JXKK.DAO.Agent
{
    ...
    /// Author:代码生成器
    /// </summary>
    public class TTAgentRechargeDAO
    {
        ...
        public List<TTAgentRecharge> GetList(string strSQL,Param param)
        {
        ...
        /// </summary>
        /// <returns>代理商充值列表对象</returns>
        public List<TTAgentRecharge> GetList(string field, string value)
        {
            List<TTAgentRecharge> list = new List<TTAgentRecharge>();
            try
            {
