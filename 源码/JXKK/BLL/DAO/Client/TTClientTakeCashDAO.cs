...
namespace Com.ZY.JXKK.DAO.Client
{
    ...
    /// Author:代码生成器
    /// </summary>
    public class TTClientTakeCashDAO
    {
        ...
        /// <param name="ttClientTakeCash">客户提现</param>
        /// </summary>
        public void Add(TTClientTakeCash ttClientTakeCash)
        {
            try
            {
                db.Open();
        ...
        /// <param name="ttClientTakeCash">客户提现</param>
        /// </summary>
        public void Edit(DataAccess data,TTClientTakeCash ttClientTakeCash)
        {
        ...
        public TTClientTakeCash Get(long flowId)
        {
        ...
        public List<TTClientTakeCash> GetList(string strSQL,Param param)
        {
        ...
        /// </summary>
        /// <returns>客户提现列表对象</returns>
        public List<TTClientTakeCash> GetList(string field, string value)
        {
            List<TTClientTakeCash> list = new List<TTClientTakeCash>();
            try
            {
        ...
        /// </summary>
        /// <returns>客户提现对象</returns>
        private TTClientTakeCash ReadData(ComDataReader dr)
        {
