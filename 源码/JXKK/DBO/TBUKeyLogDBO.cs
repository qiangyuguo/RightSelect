...
namespace Com.ZY.JXKK.DBO
{
    ...
    public class TBUKeyLogDBO
    {
        ...
        public virtual void Add(DataAccess data,TBUKeyLog tbUKeyLog)
        {
            string strSQL = "insert into TBUKeyLog (logId,uKeyId,operateType,summary,operateTime,operatorId,operatorName) values (@logId,@uKeyId,@operateType,@summary,To_date(@operateTime,'yyyy-mm-dd hh24:mi:ss'),@operatorId,@operatorName)";
        ...
        /// <param name="data">数据库连接</param>
        /// <param name="tbUKeyLog">加密狗日志</param>
        public virtual void Edit(DataAccess data,TBUKeyLog tbUKeyLog)
        {
        ...
        /// </summary>
        /// <param name="tbUKeyLog">加密狗日志</param>
        public virtual void Edit(TBUKeyLog tbUKeyLog)
        {
            try
            {
                db.Open();
        ...
        public virtual TBUKeyLog Get(long logId)
        {
        ...
        public virtual List<TBUKeyLog> GetList(string strSQL,Param param)
        {
        ...
        /// <returns>加密狗日志列表对象</returns>
        public virtual List<TBUKeyLog> GetList(string field, string value)
        {
            List<TBUKeyLog> list = new List<TBUKeyLog>();
            try
            {
        ...
        /// <returns>加密狗日志对象</returns>
        protected virtual TBUKeyLog ReadData(ComDataReader dr)
        {
