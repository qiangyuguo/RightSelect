...
namespace Com.ZY.JXKK.DBO
{
    ...
    public class TSAgentModuleDBO
    {
        ...
        public virtual void Add(DataAccess data,TSAgentModule tsAgentModule)
        {
        ...
        /// <param name="data">数据库连接</param>
        /// <param name="tsAgentModule">代理系统功能模块</param>
        public virtual void Edit(DataAccess data,TSAgentModule tsAgentModule)
        {
        ...
        /// </summary>
        /// <param name="tsAgentModule">代理系统功能模块</param>
        public virtual void Edit(TSAgentModule tsAgentModule)
        {
            try
            {
                db.Open();
        ...
        public virtual TSAgentModule Get(string moduleId)
        {
        ...
        public virtual List<TSAgentModule> GetList(string strSQL,Param param)
        {
        ...
        /// <returns>代理系统功能模块列表对象</returns>
        public virtual List<TSAgentModule> GetList(string field, string value)
        {
            List<TSAgentModule> list = new List<TSAgentModule>();
            try
            {
        ...
        /// <returns>代理系统功能模块对象</returns>
        protected virtual TSAgentModule ReadData(ComDataReader dr)
        {
