...
namespace Com.ZY.JXKK.DBO
{
    ...
    public class TBTerminalLogDBO
    {
        ...
        public virtual void Add(DataAccess data,TBTerminalLog tbTerminalLog)
        {
            string strSQL = "insert into TBTerminalLog (logId,terminalId,operateType,summary,operateTime,operatorId,operatorName) values (@logId,@terminalId,@operateType,@summary,To_date(@operateTime,'yyyy-mm-dd hh24:mi:ss'),@operatorId,@operatorName)";
        ...
        /// <param name="data">数据库连接</param>
        /// <param name="tbTerminalLog">终端日志</param>
        public virtual void Edit(DataAccess data,TBTerminalLog tbTerminalLog)
        {
        ...
        /// </summary>
        /// <param name="tbTerminalLog">终端日志</param>
        public virtual void Edit(TBTerminalLog tbTerminalLog)
        {
            try
            {
                db.Open();
        ...
        public virtual TBTerminalLog Get(long logId)
        {
        ...
        public virtual List<TBTerminalLog> GetList(string strSQL,Param param)
        {
        ...
        /// <returns>终端日志列表对象</returns>
        public virtual List<TBTerminalLog> GetList(string field, string value)
        {
            List<TBTerminalLog> list = new List<TBTerminalLog>();
            try
            {
        ...
        /// <returns>终端日志对象</returns>
        protected virtual TBTerminalLog ReadData(ComDataReader dr)
        {
