...
namespace Com.ZY.JXKK.DBO
{
    ...
    /// Author:代码生成器
    /// </summary>
    public class TTClientRechargeDBO
    {
        ...
        public virtual void Add(DataAccess data,TTClientRecharge ttClientRecharge)
        {
        ...
        /// </summary>
        /// <param name="ttClientRecharge">客户充值</param>
        public virtual void Edit(TTClientRecharge ttClientRecharge)
        {
            try
            {
                db.Open();
        ...
        public virtual List<TTClientRecharge> GetList(string strSQL,Param param)
        {
        ...
        /// <returns>客户充值列表对象</returns>
        public virtual List<TTClientRecharge> GetList(string field, string value)
        {
            List<TTClientRecharge> list = new List<TTClientRecharge>();
            try
            {
