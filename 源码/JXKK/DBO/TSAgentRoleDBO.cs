...
namespace Com.ZY.JXKK.DBO
{
    ...
    public class TSAgentRoleDBO
    {
        ...
        /// </summary>
        /// <param name="tsAgentRole">代理系统角色</param>
        public virtual void Edit(TSAgentRole tsAgentRole)
        {
            try
            {
                db.Open();
        ...
        public virtual List<TSAgentRole> GetList(string strSQL,Param param)
        {
        ...
        /// <returns>代理系统角色列表对象</returns>
        public virtual List<TSAgentRole> GetList(string field, string value)
        {
            List<TSAgentRole> list = new List<TSAgentRole>();
            try
            {
        ...
        /// <returns>代理系统角色对象</returns>
        protected virtual TSAgentRole ReadData(ComDataReader dr)
        {
